...
FactoryName = environ.get("FactoryName", "交通流量未来规划司")
...
servernumber_rabbitIP = {
	# AI_SERVER_2 为了模拟，临时修改成本机，在真实交通环境部署，需要换成真实的ip
    # "AI_SERVER_2": "127.0.0.1",
    "AI_SERVER_2": "10.248.68.244",
    "AI_SERVER_1": "127.0.0.2",
    "AI_SERVER_0": "127.0.0.3",
    "VM_0": "127.0.0.4",
}
...
print(
    "FactoryName=",
    FactoryName,
    "AI_SERVER_NUMBER_placeid_start=",
    AI_SERVER_NUMBER_placeid_start,
    "AI_SERVER_NUMBER_placeid_end=",
    AI_SERVER_NUMBER_placeid_end,
    "AI_SERVER_RABBIT_IP=",
    AI_SERVER_RABBIT_IP,
    "VM_0=",
    VM_0_RABBIT_IP,
    "Where_This_Server_ReadFrom=",
    Where_This_Server_ReadFrom,
)
