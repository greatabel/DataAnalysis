...
parser.add_argument(
    "--input_video", type=str, default="input_video.mp4", help="input video to process"
)
...
# input video
source_video = "mock_cameras/" + args.input_video
...
# Detection
def object_detection_function(command, input_video):
            ...
            while cap.isOpened():
                ...
                if csv_line != "not_available":
                    with open("traffic_measurement.csv", "a") as f:
                        ...
                        writer.writerows([csv_line.split(",")])
                queueid = None
                if args.input_video == "input_video.mp4":
                    queueid = 0
                elif args.input_video == "input_video1.mp4":
                    queueid = 1
                # send to rabbitmq
                if size != "waiting...":
                    sender(
...
object_detection_function(args.command, args.input_video)
