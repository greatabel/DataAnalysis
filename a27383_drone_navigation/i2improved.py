...
def plot_trajectory(actual_positions, estimated_positions, mean_offset, animate=False):
    if animate:
        ...
        print('len(actual_positions)====>', len(actual_positions))
        ...
        def animate(i):
            ...
            plt.grid()
        print('len(actual_positions)====>', len(actual_positions))
        # We'll take every nth element, where n is the sampling rate
...
if __name__ == "__main__":
    ...
    plot_trajectory(actual_positions, estimated_positions, mean_offset, animate=True)
