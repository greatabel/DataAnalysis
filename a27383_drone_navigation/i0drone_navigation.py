...
def plot_trajectory(actual_positions, estimated_positions, mean_offset):
    # Apply the mean offset to the estimated positions
...
if __name__ == "__main__":
    ...
    plot_trajectory(actual_positions, estimated_positions, mean_offset)
