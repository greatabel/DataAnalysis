...
def main(training_data, test_data):
    ...
    print('#'*10, training_data, test_data, training_feature_vector, test_feature_vector)
    ...
    #     print('Abel change', '#'*20)
    #     training_data = '/home/abel/AbelProject/vehicle_counting_tensorflow/utils/color_recognition_module/1training.data'
    #     test_data = '/home/abel/AbelProject/vehicle_counting_tensorflow/utils/color_recognition_module/1test.data'
    #     loadDataset(training_data, test_data, training_feature_vector, test_feature_vector)
    #     classifier_prediction = []  # predictions
    #     k = 3  # K value of k nearest neighbor
    #     for x in range(len(test_feature_vector)):
