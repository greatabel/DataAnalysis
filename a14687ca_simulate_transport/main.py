...
if __name__ == "__main__":
    show_img("resources/geographical_urban.jpg")
    ...
    for i in range(0, 5):
        ...
        while True:
            if d % 4 == 0:
                init_car_model(cell_temp, leng, cell2, 0, i / 10, 0.3)
                # init_car_model(cell_temp, leng, cell2,  0, i/100, 0.3)
            if d % 3 == 0:
                init_car_model(cell_temp, leng, cell2, 1, i / 10, 0.3)
            if d % 5 == 0:
                init_car_model(cell_temp, leng, cell2, 2, i / 10, 0.3)
