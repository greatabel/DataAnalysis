...
if __name__ == '__main__':
    ...
    for i_txt in path:
        ...
        is_warning = 0
        if ((point1 > point2 and point2 > point3 and point3 > point4 and k > 0.17) or slope > 0.17) and (type == 0 or type == 1 or type == 2 or type == 7):
            is_warning = 1
        ...
        k = float('%.3g' % k)
        result = {"monitorId": id, "type": type,"mean": mean, "changqislope":slope, "duanqislope":k, "warning": is_warning}
